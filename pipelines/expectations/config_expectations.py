    ...
    "bronze": {
        "co2_emissions": {
            ...
            "checks": [
                ...
                {"type": "column_values_in_set", "column": "country_code", 
                 "value_set": ["ARG", "BRA", "CHL", "COL", "MEX", "PER"]},  # 6+ LATAM
    ...
    "silver": {
        ...
        "transport_mode": {
            "checks": [
                ...
                {"type": "column_values_to_be_between", "column": "pct_air",
                "min_value": 0, "max_value": 100},
                {"type": "column_values_to_be_between", "column": "pct_land",
                "min_value": 0, "max_value": 100},
                # Solo 3 modos válidos de transporte dominante
                {"type": "column_values_in_set", "column": "dominant_transport",
                "value_set": ["air", "land", "sea"]},
            ]
        }
    },
    "gold": {
        "fact_tourism_emissions": {
            "checks": [
                ...
                {"type": "column_values_to_be_between", "column": "co2_per_tourist", 
                 "min_value": 0, "max_value": 10000},  # umbrales razonables
                {"type": "column_values_in_set", "column": "sustainability_label",
        ...
        "dim_country": {
            "checks": [
                ...
                {"type": "column_values_in_set", "column": "country_code",
                "value_set": ["ARG", "BOL", "BRA", "CHL", "COL", "CRI", "CUB",
                            "DOM", "ECU", "SLV", "GTM", "HND", "MEX", "NIC",
                            "PAN", "PRY", "PER", "URY", "VEN"]},
                # Todas deben ser LATAM
                {"type": "column_values_in_set", "column": "region_latam",
